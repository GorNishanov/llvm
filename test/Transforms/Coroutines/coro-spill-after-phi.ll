...
; CHECK: %f.Frame = type { void (%f.Frame*)*, void (%f.Frame*)*, i8*, i1, i1, i32, i32 }
; CHECK-LABEL: @f(
; CHECK: store void (%f.Frame*)* %{{.+}}, void (%f.Frame*)** %destroy.addr
; CHECK: %phi1 = select i1 %n, i32 0, i32 2
; CHECK: %phi2 = select i1 %n, i32 1, i32 3
; CHECK: %phi2.spill.addr = getelementptr inbounds %f.Frame, %f.Frame* %FramePtr, i32 0, i32 6
; CHECK: store i32 %phi2, i32* %phi2.spill.addr
; CHECK: %phi1.spill.addr = getelementptr inbounds %f.Frame, %f.Frame* %FramePtr, i32 0, i32 5
